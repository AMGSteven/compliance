// Test Script for specific phone numbers
...
async function testPhoneNumber(phoneNumber) {
  ...
  const lead = {
    ...
    "last_name": `Number${phoneNumber.substring(phoneNumber.length - 4)}`,
...
async function runTests() {
  // Test phone number 4083109269
  await testPhoneNumber('4083109269');
  
  // Test phone number 5555555555
  await testPhoneNumber('5555555555');
}
