...
// Read the database results
const dbData = readFileSync('/Users/rishiarmstrong/.cursor/projects/Users-rishiarmstrong-Downloads-compliance-compliance/agent-tools/ddfdbb63-4a53-4cd3-a347-d7a9a44a4779.txt', 'utf8');
const dbLeads = JSON.parse(dbData);
