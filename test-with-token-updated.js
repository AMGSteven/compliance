// Lead posting test with correct list ID and token (updated port)
...
// API endpoint with updated port (3004)
...
async function postLead(phoneNumber, description) {
  ...
  try {
    ...
    if (error.name === 'AbortError') {
      console.error(`Request for ${description} timed out after 20 seconds`);
